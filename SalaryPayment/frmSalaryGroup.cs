...
{
    public partial class frmSalaryGroup : Office2007Form
    {
        public frmSalaryGroup()
        {
            InitializeComponent();
        }
        ...
        void MaxId()
        {
            var Maxf = db.tblSalaryGroup.Select(u => u.IdSalaryGroup).DefaultIfEmpty(0).Max();
        ...
        private void frmSalaryGroup_Load(object sender, EventArgs e)
        {
            if (lblFlg.Text == "0")
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            tbl.IdSalaryGroup = Convert.ToInt32(txtId.Text);
            tbl.SalaryGroup = txtName.Text;
            tbl.BasePrice = Convert.ToInt64(txtBasePrice.Text.Replace(",", ""));

            db.tblSalaryGroup.Add(tbl);
            db.SaveChanges();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            var chk = db.Set<tblSalaryGroup>().Local.FirstOrDefault(u => u.IdSalaryGroup == Convert.ToInt32(txtId.Text));
            if (chk != null)
            {
        ...
        private void frmSalaryGroup_FormClosed(object sender, FormClosedEventArgs e)
        {
