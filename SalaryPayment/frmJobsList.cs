...
{
    public partial class frmJobsList : Office2007Form
    {
        public frmJobsList()
        {
            InitializeComponent();
        ...
        {
            SalaryDBEntities db = new SalaryDBEntities();
            dataGridViewX1.DataSource = db.tblJobs.ToList();
            Header();
        }

        void Header()
        {
            dataGridViewX1.Columns[0].HeaderText = "کد شغل";
            dataGridViewX1.Columns[1].HeaderText = "عنوان شغل";
            dataGridViewX1.Columns[2].HeaderText = "حقوق پایه";
        ...
        {
            dataGridViewX1.DataSource = db.tblJobs.Where(u=>u.JobName.Contains(txtName.Text)).ToList();
            Header();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            frm.txtBaseSalary.Text = dataGridViewX1.CurrentRow.Cells[2].Value.ToString();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("از حذف اطلاعات مطمئن هستید؟", "تایید حذف", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                Tbl = db.tblJobs.Find(Convert.ToInt64(dataGridViewX1.CurrentRow.Cells[0].Value));
                db.tblJobs.Remove(Tbl);
                db.SaveChanges();
                display();
